    ...
    if (templates.length === 0) {
        templatesList.innerHTML = `
            <div class="p-6 text-center text-gray-400">
                ...
                <p class="text-sm">Clique em "Novo Template" para criar o primeiro</p>
            </div>
        `;
        return;
    }
        ...
        <div class="p-6 border-b border-gray-700 last:border-b-0">
            <div class="flex items-start justify-between">
                ...
                <div class="flex items-center gap-2">
                    <button onclick="editTemplate('${template._id}')" class="p-2 text-blue-400 hover:bg-blue-900/20 rounded-lg transition-colors" title="Editar">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button onclick="duplicateTemplate('${template._id}')" class="p-2 text-green-400 hover:bg-green-900/20 rounded-lg transition-colors" title="Duplicar">
                        <i class="fas fa-copy"></i>
                    </button>
                    <button onclick="deleteTemplate('${template._id}')" class="p-2 text-red-400 hover:bg-red-900/20 rounded-lg transition-colors" title="Excluir">
